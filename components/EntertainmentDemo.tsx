...
import { EntertainmentMarkersDemo } from '../pages/api/EntertainmentMarkersDemo';
...
const Map: React.FC<MapProps> = ({ className }) => {
  ...
  useEffect(() => {
    ...
    if (map) {
      EntertainmentMarkersDemo.forEach((markerProps) => {
      ...
      >
        ...
        <select
          ...
          onChange={(event) => {
            ...
            const markerProps = EntertainmentMarkersDemo[index];
            map?.flyTo({
              center: [markerProps.lng, markerProps.lat],
              offset: [0, 150],
              zoom: 16.5,
            ...
            if (markerProps.title === 'EntertainmentMarkersDemo - MCG') {
              const lineString = {
                type: 'Feature',
                geometry: {
                  type: 'LineString',
        ...
        >
          ...
          {EntertainmentMarkersDemo.map((markerProps, index) => (
